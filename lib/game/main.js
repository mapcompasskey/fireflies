...
.defines(function() {
    ...
    GameStage = ig.Game.extend({
        ...
        loadLevel: function( data ) {
            ...
            // spawn hornet
            ig.game.spawnEntity( EntityHornet, ( this.tileSize * 80 ), ( this.tileSize * 20 ) );
            /*
            for ( var i = 0; i < 5; i++ ) {
                pos_x = Math.floor( 20 + ( 10 * i ) );
                pos_y = Math.floor( 20 + ( ( Math.random() * 6 ) - 3 ) );
                ig.game.spawnEntity( EntityHornet,( pos_x * this.tileSize ), ( pos_y * this.tileSize ) );
            }
            */
            
            // spawn red hornet
            ig.game.spawnEntity( EntityHornet2, ( this.tileSize * 20 ), ( this.tileSize * 10 ) );
        },
